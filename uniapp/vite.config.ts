    ...
    return defineConfig({
        ...
        plugins: [
            UniPages({
                ...
                // onBeforeLoadUserConfig: (ctx: PageContext) => {
                //     console.log('onBeforeLoadUserConfig', ctx)
                // },
                // onAfterLoadUserConfig: (ctx: PageContext) => {
                //     console.log('onAfterLoadUserConfig', ctx)
                // },
                // onBeforeScanPages: (ctx: PageContext) => {
                //     console.log('onBeforeScanPages', ctx)
                // },
                // onAfterScanPages: (ctx: PageContext) => {
                //     console.log('onAfterScanPages', ctx)
                // },
                // onBeforeMergePageMetaData: (ctx: PageContext) => {
                //     console.log('onBeforeMergePageMetaData', ctx)
                // },
                // onAfterMergePageMetaData: (ctx: PageContext) => {
                //     console.log('onAfterMergePageMetaData', ctx)
                // },
            }),
            UniLayouts(),
            UniPlatform(),
            ...
            AutoImport({
                ...
                dirs: ['src/hooks', 'src/utils/tyToast'], // 自动导入 hooks
